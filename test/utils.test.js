...
const { getString } = require('../build/utils.js');
...
describe(`Utils`, function () {
    ...
    describe(`#getString()`, function () {
        it(`should format the numbers real purty`, function () {
            assert.equal(getString(1234567890.1), `1,234,567,890.1`);
            assert.equal(getString(1234567890.0), `1,234,567,890`);
            assert.equal(getString(1234567890.0004999), `1,234,567,890.001`);
            assert.equal(getString(1234567890.0004998), `1,234,567,890`);

            // MAX_SAFE_INTEGER val
            assert.equal(getString(9007199254740991), `9,007,199,254,740,991`);
        });
        ...
        it(`should take an object and stringify with 2-space indents`, function () {
            ...
            assert.equal(getString(object), objectString);
        });
