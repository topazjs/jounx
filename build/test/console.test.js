...
describe(`Console`, function () {
    ...
    describe(`#time()`, function () {
        ...
        it(`should write a timer result to the console log output`, function () {
            ...
            const message = src_1.Logger.getTimerMessage(TIMER_ID, timerEnd, timerStart);
            const formattedMessage = logger.getFormatted(options_1.destinationTypes.CONSOLE, options_1.formatTypes.TIMER, message);
            const full = logger.getText(options_1.destinationTypes.CONSOLE, options_1.logTypes.TIMER, formattedMessage);
    ...
    describe(`#info()`, function () {
        ...
        it(`should write a line to the console info output`, function () {
            const expectedOutput = [];
            logger.info(message);
            const formattedMessage = logger.getFormatted(options_1.destinationTypes.CONSOLE, options_1.formatTypes.INFO, message);
            const full = logger.getText(options_1.destinationTypes.CONSOLE, options_1.logTypes.INFO, formattedMessage);
            expectedOutput.push(full);
        ...
        it(`should write 3 lines (first primary, next two secondary formats) to the console info output`, function () {
            ...
            const formattedMessage = logger.getFormatted(options_1.destinationTypes.CONSOLE, options_1.formatTypes.INFO, message);
            const consoleMapper = logger.getFormatted.bind(logger, options_1.destinationTypes.CONSOLE, options_1.formatTypes.INFO2);
            const otherLogText = [message2, message2a].map(consoleMapper);
            const full = logger.getText(options_1.destinationTypes.CONSOLE, options_1.logTypes.INFO, formattedMessage, ...otherLogText);
            expectedOutput.push(full);
            assert.includeMembers(infoOutput, expectedOutput);
        });
    });
    describe(`#error()`, function () {
        ...
        it(`should write a single message to the console error output`, function () {
            ...
            const formattedMessage = logger.getFormatted(options_1.destinationTypes.CONSOLE, options_1.formatTypes.ERROR, message);
            const full = logger.getText(options_1.destinationTypes.CONSOLE, options_1.logTypes.ERROR, formattedMessage);
            expectedOutput.push(full);
        ...
        it(`should write two messages to the console error output`, function () {
            ...
            const formattedMessage = logger.getFormatted(options_1.destinationTypes.CONSOLE, options_1.formatTypes.ERROR, message);
            const formattedMessage2 = logger.getFormatted(options_1.destinationTypes.CONSOLE, options_1.formatTypes.ERROR2, message2);
            const full = logger.getText(options_1.destinationTypes.CONSOLE, options_1.logTypes.ERROR, formattedMessage, formattedMessage2);
            expectedOutput.push(full);
            assert.includeMembers(errorOutput, expectedOutput);
        });
        it(`should write multiple messages of mixed types to the console error output`, function () {
            ...
            const formattedMessage = logger.getFormatted(options_1.destinationTypes.CONSOLE, options_1.formatTypes.ERROR, message);
            const messages = [message2, message3].map(logger.getFormatted.bind(logger, options_1.destinationTypes.CONSOLE, options_1.formatTypes.ERROR2));
            const full = logger.getText(options_1.destinationTypes.CONSOLE, options_1.logTypes.ERROR, formattedMessage, ...messages);
            expectedOutput.push(full);
            assert.includeMembers(errorOutput, expectedOutput);
        });
    });
    describe(`#debug()`, function () {
        ...
        it(`should write stuff to the console trace output if options.dev === true`, function () {
            ...
            const formattedMessage = logger.getFormatted(options_1.destinationTypes.CONSOLE, options_1.formatTypes.DEBUG, message);
            const full = logger.getText(options_1.destinationTypes.CONSOLE, options_1.logTypes.DEBUG, formattedMessage);
            expectedOutput.push(full);
            logger.debug(message);
